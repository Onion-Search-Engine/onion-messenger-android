...
import com.onionsearchengine.onionmessenger.databinding.ActivityShowLocationBinding;
import com.onionsearchengine.onionmessenger.ui.util.LocationHelper;
import com.onionsearchengine.onionmessenger.ui.util.UriHelper;
import com.onionsearchengine.onionmessenger.ui.widget.Marker;
import com.onionsearchengine.onionmessenger.ui.widget.MyLocation;
...
public class ShowLocationActivity extends LocationActivity implements LocationListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			switch (action) {
				case "com.onionsearchengine.onionmessenger.location.show":
