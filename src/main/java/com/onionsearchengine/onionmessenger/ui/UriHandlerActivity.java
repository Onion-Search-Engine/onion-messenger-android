...
import com.onionsearchengine.onionmessenger.utils.ProvisioningUtils;
    ...
    private void handleUri(Uri uri, final boolean scanned) {
        ...
        if (xmppUri.isAction(XmppUri.ACTION_MESSAGE)) {
            ...
            if (jid != null) {
                Class clazz;
                try {
                    clazz = Class.forName("com.onionsearchengine.onionmessenger.ui.ShareViaAccountActivity");
