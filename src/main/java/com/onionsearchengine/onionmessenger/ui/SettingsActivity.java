...
import com.onionsearchengine.onionmessenger.services.ExportBackupService;
...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		boolean removeLocation = new Intent("com.onionsearchengine.onionmessenger.location.request").resolveActivity(getPackageManager()) == null;
