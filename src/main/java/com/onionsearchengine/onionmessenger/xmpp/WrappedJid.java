...
public class WrappedJid implements com.onionsearchengine.onionmessenger.xmpp.Jid {
    ...
    @Override
    public com.onionsearchengine.onionmessenger.xmpp.Jid asBareJid() {
        return new WrappedJid(inner.asBareJid());
    }

    @Override
    public com.onionsearchengine.onionmessenger.xmpp.Jid withResource(CharSequence resource) {
    ...
    @Override
    public com.onionsearchengine.onionmessenger.xmpp.Jid getDomain() {
    ...
    @Override
    public int compareTo(com.onionsearchengine.onionmessenger.xmpp.Jid jid) {
